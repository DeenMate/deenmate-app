...
class AppLocalizationsUr extends AppLocalizations {
  ...
  @override
  String get bookmarkAll => 'تمام';

  @override
  String get bookmarkCategories => 'زمرے';

  @override
  String get bookmarkRecent => 'حالیہ';

  @override
  String get bookmarkNoBookmarksYet => 'ابھی تک کوئی بک مارک نہیں';

  @override
  String get bookmarkNoBookmarksSubtitle => 'پڑھتے وقت آیات کو بک مارک کریں تاکہ یہاں محفوظ ہو سکیں';

  @override
  String get bookmarkNoCategoriesYet => 'ابھی تک کوئی زمرہ نہیں';

  @override
  String get bookmarkNoCategoriesSubtitle => 'اپنے بک مارکس کو منظم کرنے کے لیے زمرے بنائیں';

  @override
  String get bookmarkCreateCategory => 'زمرہ بنائیں';

  @override
  String get bookmarkNoRecentBookmarks => 'کوئی حالیہ بک مارک نہیں';

  @override
  String get bookmarkNoRecentSubtitle => 'آپ کے حال ہی میں شامل کردہ بک مارکس یہاں ظاہر ہوں گے';
