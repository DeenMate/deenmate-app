...
class IslamicReferences {
  static const List<String> quranicVerses = [
    ...
    'Surah Al-Hashr 59:7 - "So what Allah gave His Messenger from them - for you did not spur for it any horses or camels, but Allah gives His messengers power over whom He wills."',
  ];
}
```
